...
def job_list(request):
    return render(request, 'jobs/joblisting.html', {'jobs': Job.objects.all()})
...
def job_search(request):
    ...
    if form.is_valid():
        ...
        return render(request, 'jobs/joblisting.html', context)
    else:
        form = SearchForm()
...
def job_detail(request, job_id):
    ...
    return render(request, 'jobs/jobdetail.html', {'job': job, 'user': UserAccount.objects.get(user=request.user)})
...
def apply_for_job(request, job_id):
    ...
    return render(request, 'jobs/jobapp.html', {'form': form})
...
def post_job(request):
    ...
    if form.is_valid():
        ...
        return redirect('job-detail', job_id=job.id)
    return render(request, 'jobs/jobpost.html', {'form': form})
