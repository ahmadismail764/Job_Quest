...
class Job(models.Model):
    ...
    posted_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='jobs_posted')
    applied_users = models.ManyToManyField(User, through='Application', related_name='jobs_applied')
